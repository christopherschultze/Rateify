                ...
                <table class="table">
                    ...
                    if(!empty($_SESSION['songs_info']))
                    {
                      ...
                      while($no_of_songs > $song_no){
                        ...
                        $artist = $_SESSION['artist_name']['user_username'];
                        $id = 1;
                        echo '<tr><th scope="row">'.$id.'</th><td>'.$song_name.'</td><td>'.$artist.'</td><td>'.$album_name.'</td><td>'.$duration.'</td><td>'.$no_of_plays.'</td> <td> <div style="position: relative;"><button style="background-color: rgb(0, 0, 0); border: black;" type = "submit"><img src="Images/Play-Button-PNG-Image.png" width="auto" height="41" /></button></div></td></tr>';
                        $song_no++;
                        $id++;
                      }
                    }
