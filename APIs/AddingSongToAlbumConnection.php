<?php
    ...
    $conn = connect();
    $_SESSION['song_add_album'] = key($_POST['song_adding_album']);

    addSongToAlbum($conn,$_SESSION['selected_album']['name'],$_SESSION['song_add_album']);

    $username = $_SESSION['username'];
    $result = searchSongsInAlbum($conn,$_SESSION['selected_album']['name']);
